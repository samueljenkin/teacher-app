...
export default function RootLayout({ children }: { children: React.ReactNode; }) {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/', icon: HomeIcon, current: path === '/' },
    { name: 'Classes', href: '/classes', icon: UsersIcon, current: path === '/classes' },
  ];
        ...
        <div>
                ...
                >
                  <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                    ...
                    <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-900 px-6 pb-4">
                      <div className="flex h-16 shrink-0 items-center gap-2 text-xl text-white text-bold">
                        <img
          ...
          <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            ...
            <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-600 px-6 pb-4">
              <div className="flex h-16 shrink-0 items-center gap-2 text-xl text-white text-2xl">
                <img
                  className="h-8 w-auto"
                  src="https://tailwindui.com/img/logos/mark.svg?color=white"
                  alt="Your Company"
